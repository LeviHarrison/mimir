...
func (a *API) RegisterDistributor(d *distributor.Distributor, pushConfig distributor.Config) {
	...
	a.RegisterRoute("/api/v1/push/otlp/v1/metrics", d.PrePushLimitsHandler(push.OLTPHandler(pushConfig.MaxRecvMsgSize, a.sourceIPs, a.cfg.SkipLabelNameValidationHeader, wrappedDistributor)), true, false, "POST")
